<template>
  <div class="equipments">
    ...
    <div class="second-nav">
      ...
      <NuxtLink class="nav-item active" to="/powershow/staff.html">
        员工风采
      </NuxtLink>
    ...
    <div class="waterfall-container">
      <div v-for="item in staffList" :key="item.id" class="waterfall-item">
...
const staffList = ref<IPowershow[] | undefined>([]);
