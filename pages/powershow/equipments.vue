<template>
  <div class="equipments">
    ...
    <div class="second-nav">
      <NuxtLink class="nav-item active" to="/powershow/equipments.html">
        设备展示
      </NuxtLink>
      <NuxtLink class="nav-item" to="/powershow/staff.html">
        员工风采
      </NuxtLink>
      <NuxtLink class="nav-item" to="/powershow/environment.html">
        公司环境
      </NuxtLink>
    </div>
    <div class="waterfall-container">
      <div v-for="item in equipmentsList" :key="item.id" class="waterfall-item">
...
const equipmentsList = ref<IPowershow[] | undefined>([]);
...
equipmentsList.value = data.value?.data;
</script>
