<template>
    <div class="nav">
        <el-menu :default-active="activeIndex" mode="horizontal" :ellipsis="false" background-color="#fff"
            text-color="#333" active-text-color="#f8c052" router>
            <!-- <div class="flex-grow" /> -->
...
// 1.取出所有导航数据
const headnav = res.data.headnav;
// console.log(headnav);
